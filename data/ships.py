...
Sources: Inara ship database, in-game Shipyard.json, and Frontier journal
         documentation.  Validated against in-game data as of 2026.
"""
...
# Inara (https://inara.cz/elite/ships/), validated against in-game data.
...
#   • Added: explorer_nx → Caspian Explorer
#   • Added: clipper → Panther Clipper (base variant)
#   • Added: scout → Taipan Fighter
...
SHIP_NAME_MAP: dict[str, str] = {
    ...
    "explorer_nx":              "Caspian Explorer",   # confirmed in journal
    # ── Saud Kruger ───────────────────────────────────────────────────────────
    ...
    "clipper":                  "Panther Clipper",         # base variant
    ...
    "federation_fighter":       "F63 Condor",       # Core Dynamics — Federal
    "scout":                    "Taipan Fighter",   # journal alias
