"""
components/exploration.py — Exploration session tracking.
...
from core.explo_value import (
    planet_base as _planet_base,
    terra_bonus as _terra_bonus,
    star_value  as _star_value,
    scan_value  as _scan_value,
    FIRST_DISC_MULT as _FIRST_DISC_MULT,
)

# Body-value math (k-factors, multipliers, and value functions) lives in
# core/explo_value.py, shared with the Exploration window.  The functions and
# _FIRST_DISC_MULT are imported above under their original local names.
